/*
  ...
  - The primary key for the `user_segments` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - You are about to alter the column `id` on the `user_segments` table. The data in that column could be lost. The data in that column will be cast from `UnsignedInt` to `Int`.
...
-- AlterTable
ALTER TABLE `user_segments` DROP PRIMARY KEY,
